...
import com.teamproj.lovehouse.model.service.HouseService;
import com.teamproj.lovehouse.model.service.HouseServiceImpl;
...
//		rightTop2.add(wordTf2);
		 ...
		 * 
		 * @Override public void actionPerformed(ActionEvent e) { searchHouses(); } };
		 * 
		...
		// ActionListener buttonHandler = new ActionListener(event -> searchHouses());
		// searchBt.addActionListener(buttonHandler);
		searchBt.addActionListener(buttonHandler -> searchHouses());
